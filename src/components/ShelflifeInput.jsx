...
const ShelflifeInput = () => {
  ...
  const handleSaveInput = async (input) => {
    try {
      ...
      if (input._id) {
        await axios.put(`https://shelflife-backend.onrender.com/shelflife/${input._id}`, input)
        ...
        await axios.post('https://shelflife-backend.onrender.com/shelflife', input)
      ...
      const response = await axios.get('https://shelflife-backend.onrender.com/shelflife')
  ...
  const handleDeleteInput = async (index) => {
    try {
      ...
      await axios.delete(`https://shelflife-backend.onrender.com/shelflife/${idToDelete}`)
