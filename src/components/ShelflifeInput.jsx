...
const ShelflifeInput = () => {
  ...
  const handleSaveInput = async (input) => {
    try {
      ...
      if (input._id) {
        await axios.put(`https://mern-backend-nr1c5n5es-iamfrankmunene.vercel.app//shelflife/${input._id}`, input)
        ...
        await axios.post('https://mern-backend-nr1c5n5es-iamfrankmunene.vercel.app//shelflife', input)
      ...
      const response = await axios.get('https://mern-backend-nr1c5n5es-iamfrankmunene.vercel.app//shelflife')
  ...
  const handleDeleteInput = async (index) => {
    try {
      ...
      await axios.delete(`https://mern-backend-nr1c5n5es-iamfrankmunene.vercel.app//shelflife/${idToDelete}`)
