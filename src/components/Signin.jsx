...
const SigninForm = ({ handleAuthenticationSuccess, handleSetUser, showLogin }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Signin successful
      const user_id = response.data.user_id; // Retrieve the user_id from the response
      handleSetUser(user_id)
