...
const WelcomePage = ({ handleAuthenticationSuccess }) => {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-purple-500">
      ...
      {showLogin === true && <LoginForm handleAuthenticationSuccess={handleAuthenticationSuccess} showLogin={setShowLogin}/>}
      {showLogin === false && <SigninForm handleAuthenticationSuccess={handleAuthenticationSuccess} showLogin={setShowLogin}/>}
    </div>
  )
}
