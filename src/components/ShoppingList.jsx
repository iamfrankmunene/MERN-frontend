...
const ShoppingList = () => {
  ...
  const fetchShoppingList = async () => {
    try {
      const response = await axios.get('https://mern-backend-ashen.vercel.app/shoppingList')
  ...
  const fetchShoppingListHistory = async () => {
    try {
      const response = await axios.get('https://mern-backend-ashen.vercel.app/shoppingHistory')
  ...
  const handleCheckboxChange = async (itemId) => {
    try {
      ...
      await axios.put(`https://mern-backend-ashen.vercel.app/shoppingList/${itemId}`, {
  ...
  const handleDeleteItem = async (itemIndex) => {
    ...
    if (!itemToDelete.completed) {
      ...
      try {
        await axios.delete(`https://mern-backend-ashen.vercel.app/shoppingList/${itemToDelete._id}`)
  ...
  const handleDeleteFromHistory = async (itemId) => {
    ...
    // Backend delete
    try {
      await axios.delete(`https://mern-backend-ashen.vercel.app/shoppingHistory/${itemId}`)
    } catch (error) {
  ...
  const handleAddToDatabase = async (itemIndex) => {
    ...
    try {
      ...
      const response = await axios.post('https://mern-backend-ashen.vercel.app/shoppingList', newItem)
